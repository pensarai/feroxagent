...
Register-ArgumentCompleter -Native -CommandName 'feroxbuster' -ScriptBlock {
    ...
    $completions = @(switch ($command) {
        'feroxbuster' {
            ...
            [CompletionResult]::new('-a', '-a', [CompletionResultType]::ParameterName, 'Sets the User-Agent (default: feroxagent/0.1.0)')
            [CompletionResult]::new('--user-agent', '--user-agent', [CompletionResultType]::ParameterName, 'Sets the User-Agent (default: feroxagent/0.1.0)')
            ...
            [CompletionResult]::new('--parallel', '--parallel', [CompletionResultType]::ParameterName, 'Run parallel feroxagent instances (one child process per url passed via stdin)')
            ...
            [CompletionResult]::new('--recon-file', '--recon-file', [CompletionResultType]::ParameterName, 'Read recon URLs from file instead of stdin')
            ...
            [CompletionResult]::new('-U', '-U ', [CompletionResultType]::ParameterName, 'Update feroxagent to the latest version')
            [CompletionResult]::new('--update', '--update', [CompletionResultType]::ParameterName, 'Update feroxagent to the latest version')
