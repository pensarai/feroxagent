...
set edit:completion:arg-completer[feroxbuster] = {|@words|
    ...
    var completions = [
        &'feroxbuster'= {
            ...
            cand -a 'Sets the User-Agent (default: feroxagent/0.1.0)'
            cand --user-agent 'Sets the User-Agent (default: feroxagent/0.1.0)'
            ...
            cand --parallel 'Run parallel feroxagent instances (one child process per url passed via stdin)'
            ...
            cand --recon-file 'Read recon URLs from file instead of stdin'
            ...
            cand --probe 'Make HTTP requests to gather more context before generating wordlist'
            ...
            cand -U 'Update feroxagent to the latest version'
            cand --update 'Update feroxagent to the latest version'
