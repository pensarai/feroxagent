...
pub const UPDATE_URL: &str = "https://api.github.com/repos/kylejryan/feroxagent/releases/latest";
...
impl Banner {
    ...
    pub fn new(tgts: &[String], config: &Configuration) -> Self {
        ...
        let wordlist = BannerEntry::new("🤖", "Wordlist", "LLM-generated");
...
██║     ███████╗██║  ██║╚██████╔╝██╔╝ ██╗██║  ██║╚██████╔╝███████╗██║ ╚████║   ██║
╚═╝     ╚══════╝╚═╝  ╚═╝ ╚═════╝ ╚═╝  ╚═╝╚═╝  ╚═╝ ╚═════╝ ╚══════╝╚═╝  ╚═══╝   ╚═╝
by Kyle Ryan {} ver: {} | based on feroxbuster by Ben "epi" Risher"#,
        ...
        W: Write,
    {
        ...
        if matches!(self.update_status, UpdateStatus::OutOfDate) {
            let update = BannerEntry::new(
                ...
                "https://github.com/kylejryan/feroxagent/releases/latest",
            );
